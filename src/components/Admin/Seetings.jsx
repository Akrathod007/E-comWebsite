...
const Seetings = () => {
  ...
  const getStatusColor = (status) => {
    ...
    else if (status === "pending") return "bg-indigo-600";
    else if (status === "dispatched") return "bg-rose-600";
    else if (status === "returned") return "bg-orange-600";
    else return "bg-cyan-600";
  };
            ...
            <div>
              ...
              <button
                className={`mt-2 ${getStatusColor(
                  item.status
                )} rounded px-3 py-1 text-xs text-white font-medium capitalize`}
              >
